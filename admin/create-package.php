...
$sql="INSERT INTO TblTourPackages(PackageName,PackageType,PackageLocation,PackagePrice,NoPersons,PackageDuration,PackageFetures,PackageDetails,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:nop,:pduration,:pfeatures,:pdetails,:pimage)";
...
$query->bindParam(':pduration',$packageduration,PDO::PARAM_INT);    
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="nop" id="nop" placeholder="Number of person for this package" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Duration</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageduration" id="packageduration" placeholder=" Package Duration in days" required>
									</div>
								</div>
<div class="form-group">
