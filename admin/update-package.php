...
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,NoPersons=:nop,PackageDuration=:pduration,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
$query = $dbh->prepare($sql);
$query->bindParam(':pname',$pname,PDO::PARAM_STR);
$query->bindParam(':ptype',$ptype,PDO::PARAM_STR);
$query->bindParam(':plocation',$plocation,PDO::PARAM_STR);
$query->bindParam(':pprice',$pprice,PDO::PARAM_STR);
$query->bindParam(':nop',$nop,PDO::PARAM_INT);    
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Persons</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="nop" id="nop" placeholder="Number of person for this package" value="<?php echo htmlentities($result->NoPersons);?>" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Duration</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageduration" id="packageduration" placeholder=" Package Duration in days" value="<?php echo htmlentities($result->PackageDuration);?>" required>
									</div>
								</div>
