...
$realdays=($to-$from)/(24*60*60);
        if($realdays!=$_SESSION['dur'])
        {
            $error="No of days are not matching!";
        }
    else{
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p><b>Package Persons :</b> <?php echo htmlentities($result->NoPersons);?></p>
				<p><b>Package Duration in Days :</b> <?php echo htmlentities($result->PackageDuration);$_SESSION['dur']=$result->PackageDuration;?></p>
